...
\figuur[0.5]{Mandelbrot}{Voorbeeld van een fractal, de Mandelbrotverzameling (Bron: \href{https://en.wikipedia.org/wiki/Mandelbrot_set}{Wikipedia}). Tip: Martin Molema kan je over dergelijke figuren van alles  vertellen. }
% Complexe getallen zijn getallen waarvan je vroeger misschien geleerd hebt dat ze niet bestaan. Immers als je $ \sqrt{-1} $ opschreef zei je leraar waarschijnlijk: 'Dat kan niet'. Toch zijn 
...
\mybv[quaternion]{Ter voorbeeld: $ q_1 = 2 - i  + 2j - 3k $ is een quaternion, net als $ q_2 = - j + k $ of  $ q_3 = 2i - j + \frac{1}{3}k. $}
