...
\begin{enumerate}
	...
	\item  $\alpha = \cos ^{-1} (\dfrac{-4}{\sqrt{5}\cdot\sqrt{13}}) = 119,7 $ 
...
\begin{enumerate}
	...
	\item $  (\vectwee{1}{3} , \vectwee{4}{-3}) = -5 $  en dus $\alpha = \cos ^{-1} (\dfrac{-5}{\sqrt{10}\cdot\sqrt{25}})= \cos ^{-1} (\dfrac{-1}{\sqrt{10}}) = 108,4 $ 
	
	\item De lengte van  $  \vec{w} \ $ is $ \ |\vec{w}| \  =  \sqrt{81} = 9 $
	
	\item afstand  $ = \frac{579}{225}\cdot\sqrt{99} = 2,65 \cdot \sqrt{99} = 26,4 $
