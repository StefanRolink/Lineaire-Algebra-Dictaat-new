...
\mydef[De som van twee vectoren $\vec{a}$ en $\vec{b}$ \ is:] {som}{\[
  \vec{a} + \vec{b} \ =\ \vecdriesnel{a} \ + \ \vecdriesnel{b} \ = \ \vecdrie{a_1+b_1}{a_2+b_2}{a_3+b_3} 
\]} 
...
\mybv[som \RD]{ Bijvoorbeeld in \RD: 
\[ 
    \vecdrie{3}{-1}{2} \ + \ \vecdrie{0}{6}{-4} \ =\ \vecdrie{3+0}{-1+6}{2+-4}\ =	\ \vecdrie{3}{5}{-2} 
\]}

\mybv[som \RT]{ En in \RT:
\[
  \vectwee{-3}{6} \ +\ \vectwee{7}{2} \ =\ \vectwee{-3+7}{6+2} \ =\ \vectwee{4}{8} \qquad \text{(zie figuur  \ref{fig:som2_new})}
\]}
...
\mydeftekst[Het scalair product van een getal $c$ en een vector $\vec{a}$ is:]{scalair  product}{
\[ 
    c \cdot \vec{a} \ = \ c\cdot \vecdriesnel{a} \ =\ \vecdrie{c\cdot a_1}{c\cdot a_2}{c\cdot a_3}
\]}

\mybv[scalair product]{ Ter voorbeeld, als $\vec{a} = \vectwee{-4}{-3} $ en $c= -2$, dan is $c \cdot \vec{a} $:
\[ 
    c \cdot \vec{a} = -2\cdot \vectwee{-4}{-3} =\ \vectwee {-2\cdot -4}{-2\cdot -3} 
                    =\ \vectwee{8}{6} \qquad \text{(Zie ook figuur \ref{fig:scalair})}
\]}
...
\mydeftekst[Het verschil tussen twee vectoren $\vec{a}$ en $\vec{b}$ is:]{verschil}{
\[ 
    \vec{a} - \vec{b} = \vecdriesnel{a} - \vecdriesnel{b} = \vecdrie{a_1-b_1}{a_2-b_2}{a_3-b_3}
\]}

\mybv[verschil \RD]{ Een voorbeeld in \RD: 
\[
    \vecdrie{3}{-1}{2} - \vecdrie {0}{6}{-4} =  \vecdrie{3-0}{-1-6}{2--4} = \vecdrie{3}{-7}{6}
\]}

\mybv[verschil \RT]{ En een voorbeeld in \RT: 
\[
    \vectwee{-3}{6} - \vectwee{7}{2} = \vectwee{-3 - 7}{6-2} = \vectwee{-10}{4} \qquad \text{(zie ook figuur \ref{fig:verschil2})}
\]}

Net zo als bij het  optellen van vectoren geldt bij het aftrekken dat alleen vectoren met dezelfde dimensie van elkaar kunnen worden afgetrokken. 
...
\figuur[0.5]{verschil2}{Het verschil van de vectoren $\vec{a}$ en $\vec{b}$ is $\vec{a} - \vec{b} = \vec{a} + -\vec{b}$.}
...
\mydef[Het inproduct van $\vec{a}$ en $\vec{b}$ is:]{inproduct}{
\[
    (\vec{a}, \vec{b}) = a_1b_1 + a_2b_2 + . . . + a_nb_n
\]}

\mybv[inproduct]{ Bijvoorbeeld, als $\vec{a} = \vecdrie{3}{-1}{2} $ en $\vec{b} = \vecdrie{0}{6}{-4} $ dan is $(\vec{a}, \vec{b})$: 
\[
    (\vec{a}, \vec{b}) = 3\cdot0 +-1\cdot6 +2\cdot-4 = 0-6-8=-14
\]}
...
\myeig[inproduct]
{
	Als $(\vec{a}, \vec{b}) = 0$, \textit{dan en slechts dan als} staat $\vec{a} $  loodrecht op $\vec{b}$    
    \qquad (voor $\vec{a} \ne \vec{0} $ en $\vec{b} \ne \vec{0} $). 
}

Oftewel in wiskundetaal: \mydeftekst{Loodrecht}{
\[
...
\mybv [loodrecht]{ Bijvoorbeeld, stel dat $\vec{a} = \vectwee{1}{-2} $ en $\vec{b} = \vectwee{2}{1} $ dan is $(\vec{a}, \vec{b})$:
\[
    (\vec{a}, \vec{b}) = 1\cdot2 + -2\cdot1 = 0 \qquad \text{(Zie ook figuur \ref{fig:loodrecht})}
\]}
...
\mydeftekst[Het uitproduct van $\vec{a}$ en $\vec{b}$ is:]{uitproduct}{
\[
    \vec{a} \times \vec{b} \ = \ \vecdriesnel{a} \ \times\ \vecdriesnel{b} \ =\ \vecdrie{a_2\cdot b_3 -a_3\cdot b_2}{a_3\cdot b_1 -a_1\cdot b_3}{a_1\cdot b_2 - a_2\cdot b_1}
\]} 

\mybv[uitproduct]{ Bijvoorbeeld, als $\vec{a} = \vecdrie{-1}{2}{4} $ en $\vec{b} = \vecdrie{3}{-2}{1} $, dan is $\vec{c} = \vec{a} \times \vec{b}$:
\[
    \vec{c} = \vec{a}\times \vec{b} = \vecdrie{2\cdot1 - 4\cdot-2}{4\cdot3--1\cdot1}{-1\cdot-2 - 2\cdot3} = \vecdrie{10}{13}{-4}
\]}

\myeig[uitproduct]{Een belangrijke eigenschap van het uitproduct is de volgende:

De vector $\vec{c}\ =\ \vec{a} \times \vec{b}$ staat loodrecht op $\vec{a}$ en loodrecht op $\vec{b}$}

\mybv[loodrecht]{ Neem bijv.: $ \vec{a},\ \vec{b}$ en $\vec{c}$ als hierboven,dan is:}
\begin{align*}
    (\vec{c}, \vec{a}) &= 10\cdot-1 + 13\cdot2 -4\cdot4 \\
                       &= -10+26-16 \\
                       &=0
\end{align*}
en:
\begin{align*}
    (\vec{c}, \vec{b}) &= 10\cdot3 + 13\cdot-2 -4\cdot1 \\
    &= 30-26-4 \\
    &=0
\end{align*}
...
\mydeftekst[De norm van een vector $\vec{a}$ is:]{norm}{
\[
    |\vec{a}| = \sqrt{ {a_1}^{2} + {a_2}^{2} + . . . +{a_n}^{2}}
\]}

\mybv[norm]{ Ter voorbeeld, als $\vec{a} = \vectwee{3}{4} $ dan is $|\vec{a}|$:
\[
    |\vec{a}| = \sqrt{ 3^{2} + 4^{2}} = 5 
\]}
En dit principe werkt ook met hogere dimensies:   
\[	
    \text{Als } \vec{v} = \vecvijf{3}{1}{-3}{4}{-1} \ \text{ dan is } |\vec{v}| = \sqrt{3^{2}+1^{2}+(-3)^{2}+4^{2}+(-1)^{2}} = 6
\]

\subsubsection{Eenheidsvector}
Soms is het nodig om vectoren met lengte 1 te hebben:
\mydeftekst{eenheidsvector}{Een eenheidsvector is een vector met lengte $1$.}
Een eenheidsvector wordt genoteerd met een accent circonflexe (\textasciicircum \ , dakje). 

\mybv[eenheidsvector]{ Bijvoorbeeld: \[\hat{e} = \vecdrie {0}{0}{1}\]}

Een willekeurige vector $\vec{v}$ is te schalen naar een eenheidsvector door $\vec{v}$ te vermenigvuldigen met $\dfrac{1}{\text{norm}} =  \dfrac{1}{|\vec{v}|}$. Dat wil zeggen $\hat{v} = \dfrac{1}{|\vec{v}|}\cdot\vec{v}$, oftewel: $\dfrac{\vec{v}}{|\vec{v}|}$ 

\mybv[eenheidsvector]{ De berekening van een eenheidsvector in 5 dimensies gaat als volgt, als:
\[
    \vec{v} = \vecvijf{3}{1}{-3}{4}{-1} \quad \text{dan is } |\vec{v}| = 6 \quad \text{(zie boven)}
\]}	
en is $\hat{v}$:
\[
    \hat{v} = \dfrac{1}{|\vec{v}|}\cdot\vec{v} = \frac{1}{6} \cdot\vecvijf{3}{1}{-3}{4}{-1} \ 
            = \vecvijf{\nicefrac{3}{6}}{\nicefrac{1}{6} }{-\nicefrac{3}{6}}{\nicefrac{4}{6}}{-\nicefrac{1}{6}}\ 
            = \vecvijf{\nicefrac{1}{2}}{\nicefrac{1}{6}}{-\nicefrac{1}{2}}{\nicefrac{2}{3}}{-\nicefrac{1}{6}}
\]
...
\mydeftekst[De formule voor de hoek tussen  vectoren $\vec{a}$ en $\vec{b}$ gebruikt het inproduct en de norm:]{hoek}{
\[
...
\mydeftekst[De \textit{vergelijking} van een lijn $l$ in \RT is: ] {lijn \RT}{\[y = ax + b\]} Met $a$ de richtingscoëfficiënt en $b$ een constante (het snijpunt met de $y$-as).

\mybv[lijn \RT]{ Ter voorbeeld, neem de lijn $l$: \[l: y = -\frac{1}{2}x +4\] Hiervan is de richtingscoëfficiënt $-\frac{1}{2}$ en het snijpunt met de $y$-as $4$. (zie ook figuur \ref{fig:lijn2d_new})}

\mydeftekst[De \textit{vectorvoorstelling} van een lijn $l$ in \RT is: ]{lijn \RT}{ 
\[
    \vectwee{x}{y} \ =\ \vectweesnel{b} \ +\ \lambda\ \vectweesnel{r} \qquad \qquad \text{of: } \vec{x} = \vec{b}+\ \lambda \vec{r}
\]} 

Met  $\vec{x}  =  \vectwee{x}{y} $ en beginvector (ook wel steun- of basisvector genoemd) $ \vec{b} =  \vectweesnel{b} $ ,  
...
\mybv[lijn \RT]{ Een voorbeeld van een vectorvoorstelling is: $m: \vectwee{x}{y} \ =\ \vectwee{-5}{0} \ +\ \lambda \ \vectwee{0}{-1} $.  Zie figuur  \ref{fig:lijn2d_new}. De richtingsvector van $m$ is $\overrightarrow{rv_m} =\vectwee{0}{-1} $ en de beginvector $\vec{b} = \vectwee{-5}{0} $}

\figuur[0.5]{lijn2d_new}{De lijn $l: y = -\frac{1}{2}x +4$. met $rc= -\frac{1}{2}$ en (los daarvan) de lijn $m$ met de rode richtingsvector en zwarte beginvector.}

\subsection{Definities vlak}
\mydeftekst[De \textit{vergelijking} van een vlak $V$ in \RD is: ]{vlak \RD}{
\[
    ax + by + cz = d \quad  \quad \text{($a$, $b$, $c$ en $d$ zijn constanten)}
\]}

\newpage
\mybv[vlak \RD]{ Een voorbeeld van een vergelijking van een vlak $ V $ is: 
\[
    V: 2x-3y+7z = -5
\]}

\mydeftekst[De \textit{vectorvoorstelling} van een vlak $ V $ in \RD is: ]{vlak \RD}{
\[
    \vecdrie{x}{y}{z} \ =\ \vecdriesnel{b}\ + \lambda\cdot\vecdriesnel{v} \ +\ \mu\cdot \vecdriesnel{w} \qquad \qquad  
    \text{of: } \vec{x} = \vec{b} +\ \lambda\ \vec{v} + \ \mu\ \vec{w}
\]}

\[ 
    \text{Met } \vec{x} =\ \vecdrie{x}{y}{z} \quad \vec{b} =\ \vecdriesnel{b} \quad \vec{v} =\ \vecdriesnel{v} \quad \vec{w} =\ \vecdriesnel{w}
\]

$\lambda$ en $\mu$ zijn variabele getallen ($\mu$, spreek uit: muu, is de Griekse letter m). En $\vec{b}$ is een constante beginvector en $\vec{v}$ en $\vec{w}$ zijn richtingsvectoren van vlak $V$.

\mybv[vlak \RD]{ Een voorbeeld van een vectorvoorstelling van een vlak $V$ is: 
\[
    V:\ \vecdrie{x}{y}{z} \ = \ \vecdrie{1}{-3}{0} \ + \lambda\cdot  \vecdrie{1}{2}{-2} \ + \  \mu\cdot \vecdrie{-4}{1}{2}
\]}

Wat $\lambda$ (spreek uit: lambda) en $\mu$ (spreek uit: muu) zijn wordt verderop bij de berekeningen uitgelegd (zie ook figuur  \ref{fig:vlak}). In lineaire algebra heb je soms de vergelijking, soms de vectorvoorstelling nodig. 

\figuur[1]{vlak}{Het (oneindige) vlak $V$ heeft de beginvector $\vec{s}$, en richtingsvectoren $\vec{v}$ en $\vec{w}$. Het punt $P$ ligt op $V$ en kun je vanuit \textit{\textbf{O}}, de oorsprong bereiken door $\vec{s} + \lambda\cdot\vec{v} + \mu\cdot\vec{w}$ met $\lambda = 2$ en $\mu = 1,5$. Elk punt van $V$ is op zo'n manier te bereiken. Met andere woorden $V: \vec{x} = \vec{s} + \lambda\cdot\vec{v} + \mu\cdot\vec{w}$.}
...
\figuur[0.6]{lijnVV}{De lijn  $ l:  \ y = - \frac{1}{2}x + 2\frac{1}{2} $. Let op de steunvector (\red{rood}) en de richtingsvector (zwart).} 
...
Neem als voorbeeld het vlak: $ -x + 2y -2z = 6 $. 
...
Die laatste vergelijking van $y$ lijkt al heel erg op een vergelijking van een vlak. Het enige dat we nu nog hoeven doen is deze om te zetten naar de standaardvorm $ax + by + cz = d$:
\begin{align*}
  y &= -6 -3x + 2z \\
  3x + y &= -6 + 2z \\
  3x + y - 2z &= -6 \\
...
Hiermee kunnen we ook onze stelling dat $ \vec{n} = \vectwee{-2}{3} $ zou kunnen zijn, testen: 
\begin{align*}
...
\mybv[normaal lijn]{ In het algemeen geldt voor een lineaire vergelijking $ax+by = c$ dat de normaal ervan is: $\vec{n} = \vectwee{a}{b} $. Dus ter voorbeeld, is de vergelijking $3x-4y=-7$, dan is het normaal van die lijn: $\vec{n} = \vectwee{3}{-4} $.}

\subsection{Normaal van vlak}

Om goed te kunnen rekenen met vlakken hebben we een normaalvector nodig.
\label{vlaknormaal}
\mydeftekst{normaal vlak}
...
\myeig[normaal vlak]{Als $V: ax + by +cz = d $ \qquad dan is: $ \vec{n} = \vecdrie{a}{b}{c} $ \ de normaalvector van $V$.}

\mybv[normaal vlak]{ Bijv. als $ V: 7x + 3y - z = -20 $ \qquad dan is $ \vec{n} = \vecdrie{7}{3}{-1} $ de normaalvector van $V$.

Let wel op: Alle $x$-, $y$- en $z$-waardes moeten dus aan dezelfde kant van het $=$-teken staan.}
...
\mybv[normaal vlak]{ Als $W:\vec{x} = \vecdrie{0}{1}{-1} + \ \lambda\ \vecdrie{2}{-3}{1} +\ \mu\ \vecdrie{0}{1}{2} $} 
...
Als we nu voor $\lambda$ en $\mu$ beide $0$ kiezen, dan is $W$: 
\begin{align*}
...
\mybv[afstand]{ We nemen als voorbeeld voor de berekening het punt $P$ en het vlak $V$:}
...
\figuur[0.8]{afstand-2}{We moeten vanuit $ P $ beginnend -2 keer de vector $\vec{n} =  \vec{rv_{l}} $   afpassen om op V te komen. Anders gezegd:  de normaal vector van $ V $ past  precies 2 keer tussen $ V $ en $ P $, en dus is de afstand $ 2\cdot |\vec{n}| =  2\cdot |\vec{rv_{l}}| = 2\sqrt{14} $.}
...
\mybv[afstand]{ In dit voorbeeld berekenen we wederom de afstand van vlak $V$ en punt $P$. Hierbij is het volgende gegeven:}
...
\begin{enumerate}
    ...
    \[
      P=(7,0,-2) \qquad V:\vecdrie{x}{y}{z} = \vecdrie{8}{-5}{3} + \lambda\vecdrie{3}{-2}{1} + \mu \vecdrie{-5}{3}{-2} 
    \]
\end{enumerate}
