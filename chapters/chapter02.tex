...
\mybv[som \RD]{$\quad \vecdrie{3}{-1}{2} \ + \ \vecdrie{0}{6}{-4} \ =\ \vecdrie{3+0}{-1+6}{2+-4}\ =	\ \vecdrie{3}{5}{-2} $}

\mybv[som \RT]{$\quad \vectwee{-3}{6} \ +\ \vectwee{7}{2} \ =\ \vectwee{-3+7}{6+2} \ =\ \vectwee{4}{8} \qquad$ (zie figuur  \ref{fig:som2_new}).}
...
\mydef[Het verschil tussen twee vectoren  \V{a}  en  \V{b} \ is:
...
Bijvoorbeeld, als $\vec{a} = \vecdrie{3}{-1}{2} $ en $\vec{b} = \vecdrie{0}{6}{-4} $ dan is 
\mybv[inproduct]{$(\vec{a}, \vec{b}) = 3\cdot0 +-1\cdot6 +2\cdot-4 = 0-6-8=-14$}
...
Oftewel in wiskundetaal: \mydef{Loodrecht}{$(\vec{a}, \vec{b}) = 0 \Leftrightarrow \vec{a} \perp \vec{b}$.}
...
{$\vec{a} \times \vec{b} \ = \ \vecdriesnel{a}  \ \times  \ \vecdriesnel{b} \ 
	= \ \vecdrie{a_2\cdot b_3 -a_3\cdot b_2}{a_3\cdot b_1 -a_1\cdot b_3}{a_1\cdot b_2 - a_2\cdot b_1} $} 

\mybv[uitproduct]{ als $ \vec{a} =  \ \vecdrie{-1}{2}{4} $ en  $ \vec{b} =  \ \vecdrie{3}{-2}{1} $ 
	\quad dan is \quad $ \vec{c} = \vec{a}  \times  \vec{b} \ = \ \vecdrie{2\cdot1 - 4\cdot-2}{4\cdot3--1\cdot1}{-1\cdot-2 - \cdot.3} = \ \vecdrie{10}{13}{-4} $}
...
\mydef[De norm van een vector \V{a} is:
...
\mybv[eenheidsvector]{als \ $ \vec{v} =\  \vecvijf{3}{1}{-3}{4}{-1} $, \ dan is $  |\vec{v}| = 6$ (zie boven) 
    ...
    $ \hat{v} =  \frac{1}{ |\vec{v}|}\cdot\vec{v} = \frac{1}{6} \cdot\vecvijf{3}{1}{-3}{4}{-1} \ = \  \vecvijf{\nicefrac{3}{6}}{\nicefrac{1}{6} }{-\nicefrac{3}{6}}{\nicefrac{4}{6}}{-\nicefrac{1}{6}}\ \  = \  \vecvijf{\nicefrac{1}{2}}{\nicefrac{1}{6}}{-\nicefrac{1}{2}}{\nicefrac{2}{3}}{-\nicefrac{1}{6}} $}
...
\mydef  [De \textit{vectorvoorstelling} van een lijn $ l $ in \RT is: ]{lijn \RT}
...
\mybv[lijn \RT]
{\raggedright Een voorbeeld van een vectorvoorstelling is: $ m: \vectwee{x}{y} \ = \ \vectwee{-5}{0} \  + \ \lambda \ \vectwee{0}{-1}. $  Zie figuur  \ref{fig:lijn2d_new}. De richtingsvector van $m$ is $\overrightarrow{rv_m} =\vectwee{0}{-1} \ $ 
	en de beginvector $\vec{b} = \vectwee{-5}{0} $
} 
\figuur[0.5]{lijn2d_new}{De lijn  $ l: y = -\frac{1}{2}x +4. $ met  $ r.c.= -\frac{1}{2}$ en (los daarvan) de lijn $m$ met de rode richtingsvector en zwarte beginvector.}

\subsection{Definities vlak}
\mydef [De \textit{vergelijking} van een vlak $V$ in \RD is: ]{vlak \RD} 
{$ ax + by + cz = d $. \quad  \quad ($a$, $b$, $c$ en $d$ zijn constanten) }
...
{vlak \RD}  
{$\vecdrie{x}{y}{z} \ =\ \vecdriesnel{b}\ + \lambda\cdot\vecdriesnel{v} \ + \  \mu\cdot \vecdriesnel{w} $ \qquad \qquad  of:  $ \vec{x} = \vec{b} +\ \lambda\ \vec{v} + \ \mu\ \vec{w} $}

Met $ \vec{x}  = \   \vecdrie{x}{y}{z}  \quad    \vec{b} = \  \vecdriesnel{b} \quad    \vec{v} =  \  \vecdriesnel{v} \quad   \vec{w} =  \ \vecdriesnel{w} $  \\   $ \lambda $ en  $ \mu $ zijn variabele getallen ( $ \mu $, spreek uit: muu, is de Griekse letter m). En  $ \vec{b} $ is een constante beginvector en $ \vec{v}  $  en $ \vec{w}  $ zijn richtingsvectoren van vlak \textit{V}.

Een voorbeeld van een vectorvoorstelling van een vlak $V$ is: 
\mybv[vlak \RD]{$\qquad V:\ \vecdrie{x}{y}{z} \ = \ \vecdrie{1}{-3}{0} \ + \lambda\cdot  \vecdrie{1}{2}{-2} \ + \  \mu\cdot \vecdrie{-4}{1}{2} $}
...
\mybv[normaal vlak]{Bijv. als $ V: 7x + 3y - z = -20 $ \qquad dan is $ \vec{n} = \vecdrie{7}{3}{-1} $ de normaalvector van $V$. Let wel op: Alle $x$-, $y$- en $z$-waardes moeten dus aan dezelfde kant van het $=$-teken staan.}
