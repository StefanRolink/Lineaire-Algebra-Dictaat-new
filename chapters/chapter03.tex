...
\mybv[matrix]{\raggedright Een matrix geven we aan met een hoofdletter, bijv:
\[
...
\mydeftekst[Een \textit{vector} is:]{vector}{een matrix die bestaat uit één rij of één  kolom, en wordt zoals je al weet, \textit{niet} met een hoofdletter aangeduid maar met een kleine en een pijltje erboven.} \mybv[vector]{\raggedright Ter voorbeeld: \[\vec{v} = \vectwee{2}{3} \]}
...
\mybv[vierkante matrix]{\raggedright Bijvoorbeeld een vierkante, $4 \times 4$ matrix: $P$:
\[
...
\mybv[symmetrisch]{\raggedright Bijvoorbeeld: 
\[
