...
{0&0}   \cdot 
\mattwee{x_1}{x_2} \\
&= \ \mattwee{1\cdot x_1 + 0\cdot x_2}
{0\cdot x_1 + 0\cdot x_2}  \\
& = \ \mattwee{x_1}{0}  
\end{align*}
...
\begin{align*}
P \cdot  \mattwee{3}{4}  \ 
&= \ \mattwee{1&0}{0&0}  \ \cdot \   \mattwee{3}{4}  \\
...
\begin{align*}
\quad \ A\cdot \vec{v} \ 
&= \ \matdrie{3\cdot 2 + -1}{2\cdot 3+  -1}{-3 +  -1} \\
&= \  \matdrie{5}{5}{-4} \\
en \ dus \ \ 
...
Ook wel: $ rc_{loodlijn}\ \cdot  \ rc_{origineel} = -1 $\\ \\
